...
function onSwymLoadCallback(swat) {
  ...
  function singleWishlistAutoConfirm () {
    document.getElementById("swym-new-input-field")?.click();
  }
  ...
  document.addEventListener("swym:create-new-list", function () {
    ...
    singleWishlistAutoConfirm();
    setTimeout(singleWishlistAutoConfirm, 500);
    setTimeout(singleWishlistAutoConfirm, 1000);
  });
